...
% DADOS DO TRABALHO--------------------------------------------------------------------------------------
\titulo{\sout{Às Margens do Capitalismo de Vigilância: }O Núcleo de Tecnologia do MTST e a Luta por Soberania Digital}
%Termografia Dinâmica para Auxílio na detecção de indicadores de Câncer de Mama
\titleabstract{\sout{At the Margins of Surveillance Capitalism: }The MTST Technology Sector and the Struggle for Digital Sovereignty}
